...
<template>
    <div class="row">
        <ul class="pagination justify-content-center">
            <li class="page-item">
                <a class="page-link p-4" @click="onPageChange(1)">최신</a>
            </li>
            <li class="page-item">
                <a class="page-link p-4" @click="onPageChange(startPage == 1 ? 1 : startPage - 1)">이전</a>
            </li>
            ...
            <li class="page-item">
                <a class="page-link p-4" @click="onPageChange(endRange ? hpStore.totalPage : endPage + 1)">다음</a>
            </li>
            <li class="page-item">
                <a class="page-link p-4" @click="onPageChange(hpStore.totalPage)">마지막</a>
            </li>
        </ul>
    </div>
</template>
